...
// 🔴 별칭(@/…)을 쓰지 않는다 — 이 묶음은 가져다 쓰는 사이트마다 다른 별칭 설정에
//    실려 들어가므로, 여기서는 형제 파일을 상대 경로로만 부른다(tsconfig.json 머리말).
import { useTableFitsWithoutOverflow } from "./useTableFitsWithoutOverflow";
